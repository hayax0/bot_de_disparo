...
export function PricingSection() {
  return (
    <section id="planos" className="py-24 bg-[#07080B] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-amber-500/10 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/25 text-amber-400 text-xs font-semibold">
            <Zap size={14} />
            <span>Assinatura Simples e Transparente</span>
          </div>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight">
            Acesso completo a todas as ferramentas
          </h2>
          <p className="text-xs sm:text-sm text-slate-400">
            Sem pegadinhas, sem cobrança por mensagem disparada e com liberação imediata.
          </p>
        </div>

        {/* Card de Preço Oficial */}
        <div className="max-w-lg mx-auto lacquer-card rounded-3xl p-6 sm:p-9 border-2 border-amber-500/40 shadow-2xl relative">
          {/* Badge Superior Flutuante */}
          <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3.5 py-1 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 text-black text-xs font-bold tracking-wide uppercase shadow-md flex items-center gap-1.5">
            <Sparkles size={12} />
          ...
          <div className="space-y-3 pt-2">
            <a
              ...
              className="w-full btn-kinpaku py-3.5 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 shadow-xl shadow-amber-500/20 text-center"
            >
