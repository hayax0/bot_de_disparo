...
export function PricingSection() {
  return (
    <section id="planos" className="py-24 bg-[#07080B] relative overflow-hidden">
      ...
      <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-purple-600/10 blur-[140px] pointer-events-none" />
